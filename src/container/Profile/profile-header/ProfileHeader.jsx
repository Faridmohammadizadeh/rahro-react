        ...
        <div>
            <div className='profile__container'>
                <div className='profile__container__main'>
                    ...
                    <div className='profile__container__main-content-bottom'>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان ی علی الخصوص ط</div>
